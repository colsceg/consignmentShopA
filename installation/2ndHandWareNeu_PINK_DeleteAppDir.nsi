...
Section "Uninstall"
  ...
  ; Optional section (can be disabled by the user)
	MessageBox MB_YESNO|MB_ICONQUESTION|MB_DEFBUTTON2 "Alle vorhandenen Daten löschen?" /SD IDNO IDYES true
			GOTO next2
		true:
		MessageBox MB_YESNO|MB_ICONSTOP|MB_DEFBUTTON2 "Alle Daten werden gelöscht, weitermachen?" /SD IDNO IDYES true1
			GOTO next2
		true1:
			# Remove AppDir
			;ADD YOUR OWN FILES HERE...
